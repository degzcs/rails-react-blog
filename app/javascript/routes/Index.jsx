      ...
      <Router>
        ...
        <Switch>
          ...
          <Route
            ...
            exact
            render={(props) => (
              <NewPost handleError={handleError} clearError={clearError} />
            )}
          />
          <Route
            ...
            exact
            render={(props) => (
              <UpdatePost handleError={handleError} clearError={clearError} />
            )}
          />
          <Route
            path="/blog/:slug"
            exact
            render={(props) => (
              <Post handleError={handleError} clearError={clearError} />
            )}
          />
        </Switch>
        <Footer />
